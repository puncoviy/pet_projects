...
function ChiefSlider(selector, config) {
  ...
  // puncoviy
    let allSlides = document.querySelectorAll("[data-index]");
    let centralSlide = allSlides[1];
    centralSlide.classList.add('slider-center');
}
...
ChiefSlider.prototype._move = function() {
  ...
  if (this._direction === 'next') {
    ...
    // puncoviy
          ...
          let allSlides = document.querySelectorAll("[data-index]");
          let currentIndex = Number(centralSlide.dataset.index)
          if (Number(centralSlide.dataset.index) < allSlides.length - 1) {
            let newCentralIndex = currentIndex + 1;
            let newCentralSlide = document.querySelector(`[data-index='${newCentralIndex}']`);
            newCentralSlide.classList.add('slider-center');
          } else {
            currentIndex = 0;
            let newCentralIndex = currentIndex;
            let newCentralSlide = document.querySelector(`[data-index='${newCentralIndex}']`);
            newCentralSlide.classList.add('slider-center');
          }
  } else {
    ...
    // puncoviy
          ...
          let allSlides = document.querySelectorAll("[data-index]");
          let currentIndex = Number(centralSlide.dataset.index)
          if (Number(centralSlide.dataset.index) > 0) {
            let newCentralIndex = currentIndex - 1;
            let newCentralSlide = document.querySelector(`[data-index='${newCentralIndex}']`);
            newCentralSlide.classList.add('slider-center');
          } else {
